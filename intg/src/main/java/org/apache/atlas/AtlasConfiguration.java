...
public enum AtlasConfiguration {
    ...
    WEBSERVER_REQUEST_IDLE_TIMEOUT("atlas.jetty.request.idle.timeout", 50000),
    ...
    NOTIFICATION_MONITOR_TOPIC_NAME("atlas.notification.monitor.topic.name", "ATLAS_MONITOR"),
    NOTIFICATION_BACKUP_TOPIC_NAME("atlas.notification.backup.topic.name", "ATLAS_BACKUP"),
    ...
    NOTIFICATION_MONITOR_CONSUMER_TOPIC_NAMES("atlas.notification.monitor.consumer.topic.names", "ATLAS_MONITOR"),
